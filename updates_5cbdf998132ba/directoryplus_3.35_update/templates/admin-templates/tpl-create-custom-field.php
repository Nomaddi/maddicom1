	...
	<div class="row">
		...
		<div class="col-md-8 col-lg-9">
			...
			<form class="form-create-custom-field" method="post">
				...
				<div class="form-group">
					<label class="label" for="tooltip"><strong><?= $txt_tooltip ?></strong></label>
				...
				<div class="form-group">
					<label class="label" for="icon"><strong><?= $txt_icon ?></strong></label>
					<input type="text" id="icon" class="form-control" name="icon">
				</div>

				<div class="form-group">
					<div><strong><?= $txt_options ?></strong></div>
					<label><input type="checkbox" id="required" name="required" value="1"> <?= $txt_required ?></label>
					<label><input type="checkbox" id="searchable" name="searchable" value="1"> <?= $txt_searchable ?></label>
				</div>

				<div class="form-group">
					<label class="label" for="values_list"><?= $txt_values_list ?></label>
