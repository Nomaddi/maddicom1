...
<div class="container mt-5">
		...
		<div class="profile-info">
			...
			<div class="profile-info-details text-center text-sm-left">
				<button type="button" class="btn btn-light" data-toggle="modal" data-target="#contact-user-modal">
					<small class="text-dark"><strong><i class="far fa-envelope"></i> <?= $txt_contact_user ?></strong></small>
				</button>
			</div>
		</div>
	</div>
	...
	<div class="mb-3">
		<ul class="nav nav-tabs" id="nav-tab" role="tablist">
			...
			<li class="nav-item mr-1">
				<a href="<?= $baseurl ?>/favorites/<?= $profile_id ?>" class="nav-link active text-dark" role="tab" aria-controls="favorites"><?= $txt_favorites ?></a>
			</li>
		</ul>
	</div>
