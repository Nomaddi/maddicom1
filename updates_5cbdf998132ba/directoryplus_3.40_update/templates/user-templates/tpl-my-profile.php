		...
		<div class="col-md-8 col-lg-9">
			...
			<form method="post" action="process-edit-profile.php">
				...
				<div class="d-flex flex-row mb-3">
					<div id="profile-pic-wrapper" class="mr-3">
						<?= $profile_pic_tag ?>
					</div>

					<div>
						<div class="mb-2">
							<button type="button" id="upload-profile-pic" class="btn btn-dark"><i class="las la-upload"></i> <?= $txt_change ?></button>
						</div>

						<div>
							<button type="button" id="delete-profile-pic" class="btn btn-dark"><i class="lar la-trash-alt"></i> <?= $txt_delete ?></button>
						</div>
					</div>
				</div>
