...
<div id="public-listings" class="container-fluid">
	...
	<div id="the-sidebar" class="sidebar bg-light">
		...
		if(!empty($top_level_cats)) {
			?>
			<div class="mb-4 p-2">
				<p><strong><i class="las la-th-list"></i> <?= $txt_categories ?></strong></p>
				<hr>
		...
		<form id="sidebar-form" class="p-2" method="get" action="<?= $baseurl ?>/results">
			...
			<!-- location -->
			<h6><i class="las la-map-marker"></i> <strong><?= $txt_location ?></strong></h6>
			<hr>
				...
				<div class="mb-3" id="li-field-<?= $v['field_id'] ?>">
					...
					elseif($v['filter_display'] == 'range_select') {
						...
						<div class="form-group">
							<div class="row g-3">
								<div class="col-6">
									<select class="form-control form-control-sm" name="field_<?= $v['field_id'] ?>[from]">
		...
		<div class="col-lg-7">
			...
			<div class="container-fluid mb-4">
				...
				<ul class="nav justify-content-end mb-2">
					<!-- filters -->
					<li class="nav-item">
						<button class="btn btn-sm btn-light mr-1" type="button" onclick="openNav()"><i class="las la-sliders-h"></i> <?= $txt_filters ?></button>
					</li>
