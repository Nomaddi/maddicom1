	...
	$('#logo_img').on('change',(function(e) {
		...
		$.ajax({
			...
			beforeSend : function() {
				...
				// Add preloader
				$('<div class="thumbs-preloader" id="logo-preloader"><i class="las la-spinner la-spin"></i></div>').appendTo('#logo-img');
			},
		...
		$.each(files, function(i, file) {
			...
			$.ajax({
				...
				beforeSend : function() {
					...
					// Add preloader
					$('<div id="' + random_id + '" class="thumbs-preloader mr-3"><i class="las la-spinner la-spin"></i></div>').appendTo('#uploaded');
				},
