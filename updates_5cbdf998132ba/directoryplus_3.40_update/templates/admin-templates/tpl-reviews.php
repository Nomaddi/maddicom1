					...
					<table class="table admin-table">
						<tr>
							...
							<th class="text-nowrap">
								...
								<?php
								$sort_icon = '<i class="las la-sort"></i>';
								if($sort == 'user') $sort_icon = '<i class="las la-sort-up"></i>';
								if($sort == 'user-desc') $sort_icon = '<i class="las la-sort-down"></i>';
	...
	$('.approve-review').on('click', function(e) {
		...
		$.post(post_url, { review_id: review_id, status: status	}, function(data) {
				if(data == 'on') {
					...
					$('#status-review-' + review_id + ' i').removeClass('la-toggle-off');
					$('#status-review-' + review_id + ' i').addClass('la-toggle-on');
				...
				if(data == 'off') {
					...
					$('#status-review-' + review_id + ' i').removeClass('la-toggle-on');
					$('#status-review-' + review_id + ' i').addClass('la-toggle-off');
