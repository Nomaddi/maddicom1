		...
		<div class="col-md-8 col-lg-9">
			...
			<form method="post" action="process-edit-profile.php">
				...
				<div class="d-flex flex-row mb-3">
					...
					<div>
						<div class="mb-2">
							<button type="button" id="upload-profile-pic" class="btn btn-dark"><i class="fas fa-upload"></i> <?= $txt_change ?></button>
						</div>

						<div>
							<button type="button" id="delete-profile-pic" class="btn btn-dark"><i class="far fa-trash-alt"></i> <?= $txt_delete ?></button>
						</div>
					</div>
				</div>
