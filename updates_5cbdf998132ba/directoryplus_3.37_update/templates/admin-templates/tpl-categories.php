					...
					<table class="table admin-table">
						<tr>
							...
							<th class="text-nowrap">
								...
								<?php
								$sort_icon = '<i class="fas fa-sort"></i>';
								if($sort == 'parent') $sort_icon = '<i class="fas fa-sort-up"></i>';
								if($sort == 'parent-desc') $sort_icon = '<i class="fas fa-sort-down"></i>';
							...
							<th class="text-nowrap">
								...
								<?php
								$sort_icon = '<i class="fas fa-sort"></i>';
								if($sort == 'order') $sort_icon = '<i class="fas fa-sort-up"></i>';
								if($sort == 'order-desc') $sort_icon = '<i class="fas fa-sort-down"></i>';
