...
CREATE TABLE IF NOT EXISTS `cats` (
  ...
  `plural_name` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `cat_slug` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `parent_id` int(11) NOT NULL DEFAULT '0',
  `cat_icon` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `cities` (
  ...
  `state` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `custom_fields` (
  ...
  `tooltip` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `icon` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `email_templates` (
  `id` int(11) NOT NULL,
  `type` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `description` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `subject` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `loggedin` (
  ...
  `token` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `neighborhoods` (
  ...
  `neighborhood_slug` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `neighborhood_name` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `pages` (
  ...
  `page_title` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `page_slug` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `meta_desc` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `places` (
  ...
  `lat` decimal(10,8) DEFAULT NULL,
  `lng` decimal(11,8) DEFAULT NULL,
  `place_name` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `slug` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `postal_code` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `cross_street` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `neighborhood` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `phone` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  `website` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `logo` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `contact_email` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `description` text COLLATE utf8mb4_unicode_ci,
  `short_desc` text COLLATE utf8mb4_unicode_ci,
  `business_hours` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `plans` (
  ...
  `plan_name` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `plan_features` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `password` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  `created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `hybridauth_provider_name` varchar(190) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT 'Provider name',
  `hybridauth_provider_uid` varchar(190) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT 'Provider user ID',
...
('en', 'public', 'results', 'txt_latest_listings', 'Latest Listings');

--
-- Update from v3.24 to v.3.25
--
