...
class ComposerAutoloaderInitf5df816b87c3f86b7d09a3bee6a2783b
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInitf5df816b87c3f86b7d09a3bee6a2783b::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequiref5df816b87c3f86b7d09a3bee6a2783b($fileIdentifier, $file);
        }
...
function composerRequiref5df816b87c3f86b7d09a3bee6a2783b($fileIdentifier, $file)
{
