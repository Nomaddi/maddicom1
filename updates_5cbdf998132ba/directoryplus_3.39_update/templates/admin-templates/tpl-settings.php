...
(function() {
    ...
    $('#stripe_create_test_webhook').click(function(e){
		...
		$('#stripe_create_test_webhook').html('<i class="fas fa-spinner fa-spin"></i> Contacting Stripe...');
    ...
    $('#stripe_create_live_webhook').click(function(e){
		...
		$('#stripe_create_live_webhook').html('<i class="fas fa-spinner fa-spin"></i> Contacting Stripe...');
