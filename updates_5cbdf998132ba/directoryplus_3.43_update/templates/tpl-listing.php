		...
		<div class="row">
			...
			<div class="col-12 col-md-5 py-2">
				...
				<div class="text-md-right social">
					...
					if(!empty($website)) {
						?>
						<a href="<?= $website_url ?>" class="mr-2" target="_blank"><i class="las la-external-link-alt"></i></a>
					<?php
					}
					...
					if(!empty($facebook)) {
						?>
						<a href="https://facebook.com/<?= $facebook ?>" class="mr-2" target="_blank"><i class="lab la-facebook-f" aria-hidden="true"></i></a>
					<?php
					}
					...
					if(!empty($instagram)) {
						?>
						<a href="https://instagram.com/<?= $instagram ?>" class="mr-2" target="_blank"><i class="lab la-instagram" aria-hidden="true"></i></a>
					<?php
					}
					...
					if(!empty($twitter)) {
						?>
						<a href="https://twitter.com/<?= $twitter ?>" class="mr-2" target="_blank"><i class="lab la-twitter" aria-hidden="true"></i></a>
					<?php
					}
					?>
					...
					<div class="dropdown-menu dropdown-menu-right zoomIn animated" aria-labelledby="shareDropdown">
						<a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?= urlencode($canonical) ?>&src=sdkpreparse" class="dropdown-item"><i class="lab la-facebook-f"></i> Facebook</a>
