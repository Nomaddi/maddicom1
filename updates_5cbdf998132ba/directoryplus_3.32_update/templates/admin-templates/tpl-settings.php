					...
					<div id="general-panel" class="tab-pane fade show active" role="tabpanel">
						...
						<div class="form-group">
							...
							<select id="cfg_use_select2" name="cfg_use_select2" class="form-control">
								<option value="0" <?php if ($cfg_use_select2 == 0) echo 'selected' ?>><?= $txt_no ?></option>
								<option value="1" <?php if ($cfg_use_select2 == 1) echo 'selected' ?>><?= $txt_yes ?></option>
							</select>
						</div>
					</div>
