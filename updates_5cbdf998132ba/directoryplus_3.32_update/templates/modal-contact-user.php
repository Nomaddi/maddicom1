		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="contact-user-form" method="post">
					...
					if($is_tpl_listing) {
						?>
						<input type="hidden" id="" name="place_id" value="<?= $place_id ?>">
						<input type="hidden" id="" name="from_page" value="listing">
						<input type="hidden" id="" name="listing_url" value="<?= $canonical ?>">
						<?php
					}
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal"><?= $txt_cancel ?></button>
