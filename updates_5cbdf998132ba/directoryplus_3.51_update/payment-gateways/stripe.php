...
// api version check. If form 2016 or 2019, it means it's a webhook that should be handled by stripe-new.php
if(!in_array(substr($event_arr['api_version'], 0, 4), array('2016','2019'))) {
	die('api_version incompatibility');
}
