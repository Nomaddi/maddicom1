...
<link rel="stylesheet" href="<?= $baseurl ?>/templates/css/line-awesome/css/line-awesome.min.css" media="print" onload="this.media='all'; this.onload=null;">
...
<!-- rss -->
<link rel="alternate" type="application/rss+xml" title="RSS Feed" href="<?= $baseurl ?>/sitemaps/rss.xml">
...
if(file_exists(__DIR__ . '/head-custom.php')) {
	include_once('head-custom.php');
}
