			...
			<form method="post" id="edit-listing-form" action="<?= $baseurl ?>/user/process-edit-listing">
				...
				<div class="form-group block" id="logo-img-row">
					...
					<div class="logo-img-controls mb-3">
						<span id="upload-logo-btn" class="btn btn-light btn-sm pointer"><i class="las la-upload"></i>
						<?= $txt_upload_logo ?></span>

						<span id="delete-logo-btn" class="btn btn-light btn-sm pointer"><i class="las la-trash-alt"></i>
						<?= $txt_delete ?></span>
					</div>
				</div>
				<!-- end logo -->
				...
				<div class="form-group">
					...
					<input type="text" id="instagram" class="form-control" name="instagram" value="<?= $instagram ?>">
				</div>
					...
					<div id="added-videos">
						...
						foreach($place_videos as $k => $v) {
							...
							<div class="form-row">
								...
								<div class="col-auto">
									<button type="button" class="btn btn-dark delete-video"><i class="lar la-trash-alt"></i></button>
								</div>
							</div>
							<?php
						}
				...
				<div style="margin-top:100px">
					<button type="submit" class="btn btn-primary"><?= $txt_save ?></button>
				</div>
			</form>
		</div>
	</div>
