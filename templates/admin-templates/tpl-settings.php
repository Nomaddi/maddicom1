			...
			<form method="post" action="<?= $baseurl ?>/admin/process-settings">
				...
				<div class="tab-content" id="tab-content">
					...
					<div id="general-panel" class="tab-pane fade show active" role="tabpanel">
						...
						<div class="form-group">
							<?= $txt_auto_approve_listing ?><br>
							<select id="cfg_auto_approve_listing" name="cfg_auto_approve_listing" class="form-control">
								<option value="1" <?php if ($cfg_auto_approve_listing == 1) echo 'selected' ?>><?= $txt_yes ?></option>
								<option value="0" <?php if ($cfg_auto_approve_listing == 0) echo 'selected' ?>><?= $txt_no ?></option>
							</select>
						</div>
						...
						<div class="form-group">
							<?= $txt_country_code ?><br>
							<select id="cfg_show_country_calling_code" name="cfg_show_country_calling_code" class="form-control">
								<option value="1" <?php if ($cfg_show_country_calling_code == 1) echo 'selected' ?>><?= $txt_yes ?></option>
								<option value="0" <?php if ($cfg_show_country_calling_code == 0) echo 'selected' ?>><?= $txt_no ?></option>
							</select>
						</div>
						...
						<div class="form-group">
							Sitemaps<br>
							<select id="cfg_enable_sitemaps" name="cfg_enable_sitemaps" class="form-control">
								<option value="0" <?php if ($cfg_enable_sitemaps == 0) echo 'selected' ?>><?= $txt_disabled ?></option>
								<option value="1" <?php if ($cfg_enable_sitemaps == 1) echo 'selected' ?>><?= $txt_enabled ?></option>
							</select>
						</div>
						...
						<div class="form-group">
							Disqus <br>
							<select id="use_disqus" name="use_disqus" class="form-control">
								<option value="0" <?php if ($use_disqus == 0) echo 'selected' ?>><?= $txt_disabled ?></option>
								<option value="1" <?php if ($use_disqus == 1) echo 'selected' ?>><?= $txt_enabled ?></option>
							</select>
						</div>

						<div class="form-group">
							General Data Protection Regulation (GDPR) <br>
							<select id="cfg_gdpr_on" name="cfg_gdpr_on" class="form-control">
								<option value="0" <?php if ($cfg_gdpr_on == 0) echo 'selected' ?>><?= $txt_disabled ?></option>
								<option value="1" <?php if ($cfg_gdpr_on == 1) echo 'selected' ?>><?= $txt_enabled ?></option>
							</select>
						</div>
					</div>
					...
					<div id="email-panel" class="tab-pane fade" role="tabpanel">
						...
						<div class="form-group">
							...
							<select name="cfg_smtp_encryption" class="form-control">
								...
								<option value="" <?= $cfg_smtp_encryption == '' ? 'selected' : '' ?>><?= $txt_none ?></option>
							</select>
						</div>
					...
					<div id="paypal-panel" class="tab-pane fade" role="tabpanel">
						...
						<div class="form-group">
							<?= $txt_cents ?><br>
							<select id="cfg_cur_without_cents" name="cfg_cur_without_cents" class="form-control">
								<option value="0" <?php if ($cfg_cur_without_cents == 0) echo 'selected' ?>><?= $txt_yes ?></option>
								<option value="1" <?php if ($cfg_cur_without_cents == 1) echo 'selected' ?>><?= $txt_no ?></option>
							</select>
						</div>
					...
					<div id="stripe-panel" class="tab-pane fade" role="tabpanel">
						...
						<div class="form-group">
							<?= $txt_create_webhook ?><br>
							<div id="stripe_create_webhook_error_msg"></div>
							<button type="button" id="stripe_create_test_webhook" class="btn btn-outline-dark"><?= $txt_create_test_webhook ?></button>
							<button type="button" id="stripe_create_live_webhook" class="btn btn-outline-dark"><?= $txt_create_live_webhook ?></button>
						</div>

						<div class="form-group">
							<?= $txt_gateway_currency ?> [<a href="https://support.stripe.com/questions/which-currencies-does-stripe-support" target="_blank"><?= $txt_stripe_currency_code ?></a>]<br>
						...
						<div class="form-group">
							<?= $txt_cents ?><br>
							<select id="stripe_min_unit_is_cent" name="stripe_min_unit_is_cent" class="form-control">
								<option value="1" <?php if ($stripe_min_unit_is_cent == 1) echo 'selected' ?>><?= $txt_yes ?></option>
								<option value="0" <?php if ($stripe_min_unit_is_cent == 0) echo 'selected' ?>><?= $txt_no ?></option>
							</select>
						</div>
					</div>
				</div>
