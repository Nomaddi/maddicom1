			...
			<div class="modal-body">
				...
				if(!empty($wa_country_code) && !empty($wa_phone)) {
					...
					<div class="mb-3">
						...
						<a href="https://wa.me/<?= $wa_country_code . $wa_area_code . $wa_phone ?>" class="btn" style="background-color:#25d366;color:white" target="_blank"><i class="lab la-whatsapp"></i> Whatsapp</a>
					</div>
					<?php
				}
				?>
