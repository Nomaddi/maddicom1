...
--
INSERT INTO `language` (`lang`, `section`, `template`, `var_name`, `translated`) VALUES
('en', 'admin', 'settings', 'txt_auto_approve_listing', 'Auto-approve listing'),
('en', 'admin', 'settings', 'txt_smtp_encryption', 'SMTP encryption'),
('en', 'admin', 'settings', 'txt_create_webhook', 'Create webhook'),
('en', 'admin', 'settings', 'txt_create_test_webhook', 'Create test webhook'),
('en', 'admin', 'settings', 'txt_create_live_webhook', 'Create live webhook'),
('en', 'admin', 'settings', 'txt_none', 'None'),
('en', 'admin', 'settings', 'txt_cents', 'Cents')
;
